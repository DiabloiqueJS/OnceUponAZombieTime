...
function( CONFIG )
{
  var datas = {
    ...
    , imagesList: [
      ...
      ,[ "stab", "stab", "jpg", { "load": true, "totalFrame": 1, "isAnimated": false } ]
      ,[ "stab_good", "stab_good", "jpg", { "load": true, "totalFrame": 1, "isAnimated": false } ]
      ,[ "hole", "hole", "jpg", { "load": true, "totalFrame": 1, "isAnimated": false } ]
      ,[ "hole_good", "hole_good", "jpg", { "load": true, "totalFrame": 1, "isAnimated": false } ]
      ,[ "wall", "wall", "jpg", { "load": true, "totalFrame": 1, "isAnimated": false } ]
      ,[ "wall_good", "wall_good", "jpg", { "load": true, "totalFrame": 1, "isAnimated": false } ]
